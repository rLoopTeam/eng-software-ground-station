...
{
    public partial class rPodCurrentGauge : UserControl
    {

        private void rPodCurrentGauge_Load(object sender, EventArgs e)
        {

        }


        public rPodCurrentGauge()
        {
            InitializeComponent();
        ...
        private void redrawBackground()
        {
            ...
            for (int i = 0; i < numOfTicks; i++)
            {
                ...
                if (i % major == 0)
                {
                    ...
                    int speedPoint = (int)((maxCurrent / (numOfTicks - 1)) * i);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            bigSpeedTextSize = e.Graphics.MeasureString(Current.ToString(), bigSpeedFont);
            e.Graphics.DrawString(Current.ToString(), bigSpeedFont, bigSpeedBrush, (float)(size / 2 - bigSpeedTextSize.Width / 2), (float)(size * .43 - bigSpeedTextSize.Height / 2));
